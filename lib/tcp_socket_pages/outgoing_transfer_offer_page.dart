...
class _OutgoingTransferOfferPageState extends State<OutgoingTransferOfferPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final receiverUsesTls =
        ...
        false;
    final receiverFingerprint =
        _receiver?['certFingerprint'] as String? ??
        widget.receiverPreview?.certificateFingerprint;
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _maybeAnimate(
                            context,
                            _ApprovalFileRow(fileName: file.name),
                            (child) => child
                                .animate()
                                .fadeIn(
...
class _OfferSurface extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: fillChild ? content : SingleChildScrollView(child: content),
    );
  }
}
